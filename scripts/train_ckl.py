...
def main(args):
    ...
    if hyper_search:
        ...
        x, loss_history, triplet_error_history, time_taken, time_history = ckl.ckl_k(triplets=train_triplets_dataset.trips_data_indices, n=n, reg_lbda=regularizer,
...
def run_hyperparameter_search(config):
    ...
    for (emb_dim, triplet_multiplier) in product(dimensions_range, triplet_multiplier_range):
        ...
        for (learning_rate, regularizer, mu) in product(learning_rate_range, regularizer_range, mu_range):
            ...
            x, loss_history, triplet_error_history, time_taken = ckl.ckl_k(triplets=train_triplets_dataset.trips_data_indices, n=n,
